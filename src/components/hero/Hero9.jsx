...
export default function Hero9() {
  ...
  return (
    <>
      <section className="hero-home10 p-0 overflow-hidden mb-5">
            ...
            <div className="row">
              <div className="col-xl-7">
                <h3 className="banner-title">
                  WRITE  <br className="d-none d-lg-block" />
                  YOUR DREAM
                </h3>
                <p className="banner-text text-white ff-heading mb30">
                  your dream our expertise
                </p>
                <div className="advance-search-tab bgc-white bdrs60 p20 bdrs4-sm banner-btn position-relative zi9">
                  <div className="row">
                    <div className="col-md-5 col-lg-6 col-xl-9">
                      <div className="advance-search-field -sm">
                        <TextArea1 />
                      </div>
                      <div className="text-center text-xl-start">
                        <button
                          onClick={searchHandler}
                          className=" btn-dark bdrs60 bdrs4-sm w-100"
                          type="button"
                        >
                          SEND
                        </button>
